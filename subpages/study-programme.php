...
<div class=" content-text" id="overview">
    <div class=" h1-border">
        ...
        <h1 id="tab-header">Study Programme</h1>

        <p class="tab-overview">
            From the beginning of the new school year, 2022-2023, the school will operate under double shift
            system for the next three to four years.
        </p>
    </div>
</div>

<!-- Content -->
<div class="tab-content" id="study-programme">
    <div class="wrapper">
